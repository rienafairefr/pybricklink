...
class Configuration(six.with_metaclass(TypeWithDefault, object)):
    ...
    def __init__(self, host="https://api.bricklink.com/api/store/v1",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("bricklink")
            ...
            'Oauth':
                {
                    ...
                    'in': 'header',
                    'key': 'Oauth1',
                    'value': self.get_api_key_with_prefix('Oauth1')
                },
        }
